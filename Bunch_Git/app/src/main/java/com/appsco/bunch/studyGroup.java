...
//
//    public studyGroup(String creator, float intensity, String studyCourse, String maxMembers, String date, String time) {
//        // Constructor with ALL details filled out
//        this.Creator = creator;
//        this.startDate = date;
//        this.startTime = time;
//        this.studyCourse = studyCourse;
//        this.message = "Join my study group for " + studyCourse + "!";
//        this.intensity = intensity;
//        this.maxMembers = maxMembers;
//    }
//
